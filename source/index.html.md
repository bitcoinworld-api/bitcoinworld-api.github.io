---
title: bitcoinworld API Documentation

language_tabs: # must be one of https://git.io/vQNgJ
  - json

toc_footers:
  - <a href='https://www.bitcoinworld.com/api/'> creat API Key </a>
includes:
...
Welcome to the bitcoinworld API!

This document is the only official API document of bitcoinworld. The features and services provided will be continuously updated here.
...
You can create an API key by clicking [here ](https://www.bitcoinworld.com/api/).
...
- Method request address: that is, access to the server address <https://api.bitcoinworld.com>
...
For example: `api.bitcoinworld.com\n`
...
```shell
curl "https://api.bitcoinworld.com/v2/reference/transact-fee-rate?symbols=btcusdt,ethusdt,ltcusdt"
```
